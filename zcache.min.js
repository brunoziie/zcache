...
!1},this.hasCache(a);this.hasCache=function(){};return!1},addToCache:function(a,c){this.isCompatible()?(this.addToCache=function(a,c){e.localStorage.setItem(a,JSON.stringify(c))},this.addToCache(a,c)):this.addToCache=function(){}},getFromCache:function(a){return JSON.parse(e.localStorage.getItem(a))},removeFromCache:function(a){this.hasCache(this.scriptsPath+a)&&e.localStorage.removeItem(this.scriptsPath+a)},loadScriptText:function(a,c){var d=this,f=new XMLHttpRequest,b=c||!0;f.open("GET",a);f.onreadystatechange=
